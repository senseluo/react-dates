...
/***/ function(module, exports, __webpack_require__) {
	...
	var propTypes = {
	  ...
	  monthInfo: _react.PropTypes.object,
	  monthInfoDateFormat: _react.PropTypes.string
	};
	  ...
	  _createClass(DayPickerRangeController, [{
	    ...
	    value: function () {
	      function render() {
	        ...
	        var monthInfo = _props8.monthInfo;
	        var monthInfoDateFormat = _props8.monthInfoDateFormat;
