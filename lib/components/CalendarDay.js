...
/***/ function(module, exports, __webpack_require__) {
	...
	var propTypes = {
	  ...
	  dayInfo: _react.PropTypes.string,
	  ...
	  _createClass(CalendarDay, [{
	    ...
	    value: function () {
	      function render() {
	        ...
	        }, _react2['default'].createElement('span', { className: 'CalendarDay__day' }, day.format('D')), dayInfo && _react2['default'].createElement('span', { className: 'CalendarDay__dayInfo' }, dayInfo));
	      }
